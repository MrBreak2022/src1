...
class Invoice(models.Model):
    ...
    line_four_unit_price = models.IntegerField('Price per Unit:', default=0, blank=True, null=True)
    line_four_total_price = models.IntegerField('Line Total (PHP):', default=0, blank=True, null=True)
    ...
    line_five_unit_price = models.IntegerField('Price per Unit:', default=0, blank=True, null=True)
